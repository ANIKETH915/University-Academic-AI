...
export default function LandingPage({ setActiveTab }) {
  ...
  return (
    <div className="space-y-12 py-4">
      ...
      {/* Hero Section */}
      <div className="saas-card p-8 sm:p-12 text-center space-y-6 relative overflow-hidden bg-gradient-to-b from-purple-950/30 via-[#0B1020] to-[#0B1020] border-purple-500/20">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-[#111827] hover:bg-[#1F2937] border border-[#1F2937] text-slate-300 font-semibold text-sm flex items-center justify-center space-x-2 transition-colors"
          >
        ...
        {createError && (
          <p className="text-xs text-rose-300 bg-rose-500/10 border border-rose-500/30 rounded-xl px-4 py-2.5 max-w-md mx-auto">
            {createError}
          </p>
        )}

        {/* Trust Badges */}
        <div className="pt-6 border-t border-[#1F2937]/60 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto text-xs text-slate-400">
      ...
      <div className="space-y-6">
        <div className="text-center space-y-1">
          <h2 className="font-heading font-extrabold text-xl text-white">How It Works</h2>
          <p className="text-xs text-slate-400">Build your private academic assistant in 3 simple steps</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          
          <div className="saas-card p-6 space-y-3 relative group hover:border-purple-500/30 transition-all">
            <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 font-extrabold flex items-center justify-center text-sm">
              1
            </div>
            <h3 className="font-heading font-bold text-sm text-white">Upload Documents</h3>
          ...
          <div className="saas-card p-6 space-y-3 relative group hover:border-purple-500/30 transition-all">
            <div className="w-10 h-10 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-extrabold flex items-center justify-center text-sm">
              2
            </div>
            <h3 className="font-heading font-bold text-sm text-white">Ask Questions</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="saas-card p-6 space-y-3 relative group hover:border-purple-500/30 transition-all">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-extrabold flex items-center justify-center text-sm">
              3
            </div>
            <h3 className="font-heading font-bold text-sm text-white">Get Grounded Answers</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
